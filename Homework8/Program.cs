...
/*
int m = InputNumbers("Введите колличество столбцов m - ");
int n = InputNumbers("Введите колличество строк n - ");
...
/*
int m = InputNumbers("Введите количество строк матрицы 1 - ");
int n = InputNumbers("Введите количество столбцов матрицы 1 - (оно совпадает с количеством строк матрицы 2 -): ");
int p = InputNumbers("Введите количество столбцов матрицы 2 - ");
